...
Following the preregistered campaign, we ran four confirmatory robustness
...
the paper claims it operates (tight-to-moderate budgets). Across all four
sweeps the \RA{} rows complete the grid: RA is Holm-significant vs FB in 15 of
...
any of the four robustness axes, which strengthens its role as the family's
