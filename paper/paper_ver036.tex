...
\begin{equation}
\mathrm{quality}(t) = \frac{\text{traversable cells with } b \le
\texttt{QUALITY\_THRESHOLD} \text{ at step } t}{\text{traversable cells}},
\end{equation}
sampled every 25 steps (normalized AUC = \texttt{quality\_auc}).
