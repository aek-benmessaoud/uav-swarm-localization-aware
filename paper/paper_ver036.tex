...
method whose advantage survives 20\% obstacle density. Confirmatory sweeps
(self-localization noise $\sigma = 0.5/1.0$, budget, fusion range, bearing
noise) show that \RA{} is Holm-significant versus FB in 15 of 16 sweep cells
across both regimes --- its only attenuation is $\sigma = 1.0$ in A3
($+3.3\%$, $ns$), where it stays positive where \CU{} inverts --- the only
member of the family with no robustness blind spot --- while a benchmarked
GDOP/FIM baseline is accuracy-co-optimal
with \RA{} but coverage-dominated by the family at $\approx 2.3\times$ compute.
...
\begin{table}[t]
\caption{CPU/decision, A6\_obs005, $n = 10$, single process (GDOP and Hybrid
rows from their own interleaved same-session benchmarks; absolute values are not
cross-session comparable on this machine, per-session ratios are).}
\label{tab:cpu}
\centering
\begin{tabular}{l c}
\toprule
...
\begin{table*}[t]
\caption{Sweep B ($n = 40$ paired): \CU{} and \RA{} vs FB on \texttt{mean\_bound\_final} at mission end (budget $T$) under self-localization noise $\sigma$ (cells); oracle keeps true geometry.}
\label{tab:sweepB}
\centering
\begin{tabular}{l c c c c c c c}
\toprule
Regime & $\sigma$ & Method & FB bound & Method bound & rel-red\% & $p$ & $p$\_Holm \\
\midrule
\multicolumn{8}{c}{\textbf{A3 (3 UAVs)}} \\
\midrule
A3 (3 UAVs) & 0.5 & \CU & 0.0227 & 0.0193 & +14.8 & 0.0178 & 0.0447 \\
A3 (3 UAVs) & 0.5 & \RA & 0.0227 & 0.0195 & +10.5 & 0.0232 & 0.0464 \\
A3 (3 UAVs) & 1.0 & \CU & 0.0226 & 0.0235 & -3.8 & 0.7547 & 0.7547 \\
A3 (3 UAVs) & 1.0 & \RA & 0.0226 & 0.0210 & +3.3 & 0.0548 & 0.0548 \\
\multicolumn{8}{c}{\textbf{A6 (6 UAVs)}} \\
\midrule
A6 (6 UAVs) & 0.5 & \CU & 0.0223 & 0.0177 & +20.8 & 0.0017 & 0.0067 \\
A6 (6 UAVs) & 0.5 & \RA & 0.0223 & 0.0191 & +18.8 & 0.0015 & 0.0051 \\
A6 (6 UAVs) & 1.0 & \CU & 0.0259 & 0.0220 & +14.9 & 0.0224 & 0.0447 \\
A6 (6 UAVs) & 1.0 & \RA & 0.0259 & 0.0205 & +18.1 & 0.0017 & 0.0051 \\
\bottomrule
\end{tabular}
\end{table*}
...
\begin{table*}[t]
\caption{Sweep C ($n = 40$ paired): \CU{} and \RA{} vs FB across mission budgets $T = \{0.3, 0.5, 0.7, 0.9\} \times$ FB \texttt{steps\_90}.}
\label{tab:sweepC}
\centering
\begin{tabular}{l c c c c c c c}
\toprule
Regime & $T{\times}$FB & Method & FB bound & Method bound & rel-red\% & $p$ & $p$\_Holm \\
\midrule
\multicolumn{8}{c}{\textbf{A3 (3 UAVs)}} \\
\midrule
A3 (3 UAVs) & 0.3 & \CU & 0.0545 & 0.0386 & +29.2 & $<$0.0001 & $<$0.0001 \\
A3 (3 UAVs) & 0.3 & \RA & 0.0545 & 0.0373 & +31.7 & $<$0.0001 & $<$0.0001 \\
A3 (3 UAVs) & 0.5 & \CU & 0.0350 & 0.0280 & +20.1 & $<$0.0001 & $<$0.0001 \\
A3 (3 UAVs) & 0.5 & \RA & 0.0350 & 0.0254 & +27.4 & $<$0.0001 & $<$0.0001 \\
A3 (3 UAVs) & 0.9 & \CU & 0.0125 & 0.0113 & +9.1 & 0.2265 & 0.2265 \\
A3 (3 UAVs) & 0.9 & \RA & 0.0125 & 0.0096 & +23.1 & $<$0.0001 & 0.0001 \\
\multicolumn{8}{c}{\textbf{A6 (6 UAVs)}} \\
\midrule
A6 (6 UAVs) & 0.3 & \CU & 0.0449 & 0.0361 & +19.5 & $<$0.0001 & $<$0.0001 \\
A6 (6 UAVs) & 0.3 & \RA & 0.0449 & 0.0324 & +27.9 & $<$0.0001 & $<$0.0001 \\
A6 (6 UAVs) & 0.5 & \CU & 0.0333 & 0.0254 & +23.8 & $<$0.0001 & $<$0.0001 \\
A6 (6 UAVs) & 0.5 & \RA & 0.0333 & 0.0229 & +31.2 & $<$0.0001 & $<$0.0001 \\
A6 (6 UAVs) & 0.9 & \CU & 0.0139 & 0.0123 & +11.1 & 0.0058 & 0.0117 \\
A6 (6 UAVs) & 0.9 & \RA & 0.0139 & 0.0117 & +16.0 & 0.0008 & 0.0008 \\
\bottomrule
\end{tabular}
\end{table*}
...
\begin{table*}[t]
\caption{Sweep D ($n = 40$ paired): \CU{} and \RA{} vs FB under reduced proximity-fusion range $R \in \{2.5, 1.25\}$ cells (default $R =$ FOV $= 5$).}
\label{tab:sweepD}
\centering
\begin{tabular}{l c c c c c c c}
\toprule
Regime & $R$ & Method & FB bound & Method bound & rel-red\% & $p$ & $p$\_Holm \\
\midrule
\multicolumn{8}{c}{\textbf{A3 (3 UAVs)}} \\
\midrule
A3 (3 UAVs) & 2.5 & \CU & 0.0268 & 0.0217 & +19.2 & 0.0014 & 0.0014 \\
A3 (3 UAVs) & 2.5 & \RA & 0.0268 & 0.0194 & +27.4 & $<$0.0001 & $<$0.0001 \\
A3 (3 UAVs) & 1.25 & \CU & 0.0282 & 0.0208 & +26.2 & $<$0.0001 & $<$0.0001 \\
A3 (3 UAVs) & 1.25 & \RA & 0.0282 & 0.0209 & +25.9 & $<$0.0001 & $<$0.0001 \\
\multicolumn{8}{c}{\textbf{A6 (6 UAVs)}} \\
\midrule
A6 (6 UAVs) & 2.5 & \CU & 0.0254 & 0.0199 & +21.6 & $<$0.0001 & $<$0.0001 \\
A6 (6 UAVs) & 2.5 & \RA & 0.0254 & 0.0173 & +31.9 & $<$0.0001 & $<$0.0001 \\
A6 (6 UAVs) & 1.25 & \CU & 0.0233 & 0.0196 & +15.7 & 0.0010 & 0.0014 \\
A6 (6 UAVs) & 1.25 & \RA & 0.0233 & 0.0178 & +23.5 & $<$0.0001 & $<$0.0001 \\
\bottomrule
\end{tabular}
\end{table*}
...
\begin{table*}[t]
\caption{Sweep E ($n = 40$ paired): \CU{} and \RA{} vs FB on \texttt{mean\_bound\_final} at mission end (budget $T$) under bearing-measurement noise $\sigma_\theta = 2^\circ$ applied to the local angular observations; oracle keeps true geometry.}
\label{tab:sweepE}
\centering
\begin{tabular}{l c c c c c c c}
\toprule
Regime & $\sigma_\theta$ (deg) & Method & FB bound & Method bound & rel-red\% & $p$ & $p$\_Holm \\
\midrule
\multicolumn{8}{c}{\textbf{A3 (3 UAVs)}} \\
\midrule
A3 (3 UAVs) & 2.0 & \CU & 0.0222 & 0.0174 & +21.6 & $<$0.0001 & $<$0.0001 \\
A3 (3 UAVs) & 2.0 & \RA & 0.0222 & 0.0185 & +16.8 & 0.0001 & 0.0001 \\
\multicolumn{8}{c}{\textbf{A6 (6 UAVs)}} \\
\midrule
A6 (6 UAVs) & 2.0 & \CU & 0.0244 & 0.0187 & +23.4 & 0.0001 & 0.0001 \\
A6 (6 UAVs) & 2.0 & \RA & 0.0244 & 0.0174 & +28.6 & $<$0.0001 & $<$0.0001 \\
\bottomrule
\end{tabular}
\end{table*}
...
the only method whose edge survives 20\% obstacle density --- and the
confirmatory sweeps show it is the only member with no blind spot on any
robustness axis (noise, budget, fusion range, bearing noise; Holm-significant
vs FB in 15 of 16 sweep cells, with the single $\sigma = 1.0$ / A3 attenuation
staying positive where \CU{} inverts); \CU{} provides a stable, equally cheap
continuous weighting that is optimal in sparse environments and robust across
its plateau. The GDOP/FIM baseline is accuracy-co-optimal with \RA{} but is
coverage-dominated by the whole family at $\approx 2.3\times$ compute, and the
two dense-regime variants (dynamic normalization, the CU$\leftrightarrow$RA
hybrid) are now evaluated rather than deferred. The universal
...
globally. The topology dossier (Section~VI-L) sharpens the
boundary: the advantage survives line-of-sight occlusion when routing choice is
preserved (cluster topologies, reproduced at 3 and 6 UAVs) and flips negative
only under single-path routing (perfect maze) --- routing redundancy, not
spatial fragmentation per se, is the condition for the trade-off. The headline
claims of the paper (sparse open space, Sections~VI-D--VI-K) are unchanged.
